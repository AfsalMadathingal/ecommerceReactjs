      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 md:pl-8 mt-4 md:mt-0">
          ...
          <div className="flex items-center mt-2">
            <span className="text-gray-900 text-xl font-bold mr-2">{product.price}</span>
          ...
          <button className="mt-4 w-full md:w-auto bg-gray-800 text-white px-4 py-2 rounded-md">Add to Cart</button>
          <div className="flex items-center mt-4">
            <button className="text-gray-700 hover:underline mr-4">Add to wishlist</button>
